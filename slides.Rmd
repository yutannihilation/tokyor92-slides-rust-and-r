...
[![](/images/screenshot_r-wakalang.png){width=450px}](https://r-wakalang.slack.com/archives/C023FCNPV8B)
...
* extendrのロゴはCC-BY-SA 4.0ライセンスで配布されています: <https://github.com/extendr/artwork>.
